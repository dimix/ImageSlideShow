#
#  Be sure to run `pod spec lint ImageSlideShow.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Dimitri Giani"
  # s.authors            = { "Dimitri Giani" => "dimitri.giani@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Dimitri Giani"
  ...
  s.source_files  = "Classes", "Sources/ImageSlideShow/Classes/**/*.{swift}"
  s.source_files  = "Extensions", "Sources/ImageSlideShow/Extensions/**/*.{swift}"
